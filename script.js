document.addEventListener('DOMContentLoaded', function() {
    const leaderboard = [
        ...
        { name: 'iphone rosso', points: 21, image: 'verde.png' },
        ...
        { name: 'sara la rue', points:10, image: 'verde.png' },
        { name: 'la lazzarinihh', points: 7, image: 'rosso.png' },
        { name: 'diabete man', points: 5, image: 'rosso.png' },
